package el.arn.timecalc.mainActivity.ui.calculatorButtonsLayouts
...
import el.arn.timecalc.mainActivity.MainActivity
...
class ButtonsContainerTopPartImpl(activity: MainActivity, initScrollPercent: Float = 0f) : ButtonsContainerTopPart {
    ...
    private class TopRow(activity: MainActivity) {
    ...
    private class BottomRow(activity: MainActivity) {
