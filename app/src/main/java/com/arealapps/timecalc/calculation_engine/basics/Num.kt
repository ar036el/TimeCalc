package com.arealapps.timecalc.calculation_engine.basics

import com.arealapps.timecalc.calculation_engine.basics.Num.Companion.UNARY_MINUS
import com.arealapps.timecalc.calculation_engine.result.CantDivideByZeroException
import com.arealapps.timecalc.calculation_engine.symbol.DecimalPoint
import com.arealapps.timecalc.calculation_engine.symbol.Digit
import com.arealapps.timecalc.helpers.native_.Wrapper
...
class NumImpl(numberAsString: String) : Num {
    ...
    override fun compareTo(other: Num): Int {
        return BigDecimal(numberAsString).compareTo(BigDecimal(other.toStringUnformatted()))
    }
