...
interface PreResultNumeral {
    /**
     * 'Numeral' is a type of quantity. it can be 3 things: a number, a time quantity or a mix between them.
     * *this class is called "Pre-result Numeral" because it's used for building the final calculation result
    */
